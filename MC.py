...
#         mainSprite = self.loadImage("chibi-layered.png")
#         mainSprite = self.scaleImage(mainSprite, 4)
#         self.mainSprite = dict()
#         mainWidth, mainHeight = mainSprite.size
#         self.mainChoice = 2 # which main character (0,1,2)
#         self.mainX = startX
#         self.mainY = startY
...
def appStarted(app):
    ...
    app.mainSprite = dict()
    mainWidth, mainHeight = mainSprite.size
    app.mainChoice = 2 # which main character (0,1,2)
